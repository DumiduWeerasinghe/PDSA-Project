...
public class UpdateTicket extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(btnBack, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 340, 340, 50));

        btnUpdate.setFont(new java.awt.Font("Poppins", 0, 24)); // NOI18N
        ...
        jPanel1.add(btnUpdate, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 280, 340, 50));
        ...
        jPanel1.add(txtDescription, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 220, 200, -1));

        txtName.setFont(new java.awt.Font("Poppins", 0, 18)); // NOI18N
        jPanel1.add(txtName, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 170, 200, -1));
        ...
        jPanel1.add(txtID, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 120, 200, -1));
        ...
        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/trainticketbooking/222.jpg"))); // NOI18N
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        ...
        // Get the ticket ID and new details from the form
    String ticketId = txtID.getText();
    String newCustomerName = txtName.getText();
    String newIssueDescription = txtDescription.getText();
